...
class ModelProduk : AppCompatActivity() {
    ...
    private val galleryLauncher = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            // Tampilkan foto di preview area
            ivProductPhoto.setImageURI(selectedImageUri)
            ivProductPhoto.scaleType = android.widget.ImageView.ScaleType.CENTER_CROP
            ivProductPhoto.layoutParams = ivProductPhoto.layoutParams.also {
